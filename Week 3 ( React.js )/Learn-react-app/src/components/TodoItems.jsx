      ...
      <li className="flex bg-white rounded shadow-sm p-4 mt-4 first:mt-0">
        <div className="flex gap-x-4 mr-auto items-center">
          ...
          <div>
            ...
            <div className="text-sm text-gray-400">{props.todo.date}</div>
          </div>
        </div>
      ...
      <dialog ref={dialog} onClick={clickOutsideModal} className="rounded-md w-[480px]">
        <form onSubmit={submitForm} className="p-6">
            ...
            <div className="mt-12 text-end space-x-2">
                <button onClick={closeModal} type="button" className="rounded border border-gray-200 px-3 py-2 hover:bg-gray-300">
                    Close
                </button>
                <button type='submit' className={
                    editing ? "rounded bg-teal-500 px-3 py-2 text-white hover: bg-teal-600" :
